...
namespace SantaQuest
{
    public class Level4 : Actor
    {
        ...
        public Level4(Vector2 screenSize, ExitNotifier exitNotifier, CameraMan cameraMan, GraphicsDevice graphicsDevice)
        {
        ...
        private void InitializeObjects()
        {
            ...
            float Blockduration1 = 0.2f;
            blocks[14].AddAction(Actions.Forever(
                new MoveByAction(Blockduration1, new Vector2(-100, 0), blocks[14]),
                new MoveByAction(Blockduration1, new Vector2(100, 0), blocks[14]),
                new MoveByAction(Blockduration1, new Vector2(0 ,0), blocks[14])
            ));
            blocks[15].AddAction(Actions.Forever(
                new MoveByAction(Blockduration, new Vector2(0, 150), blocks[15]),
                new MoveByAction(Blockduration, new Vector2(0, -150), blocks[15])
            ));
            ...
            float Spikeduration = 1f;
            spikedowns[0].AddAction(Actions.Forever(
                new MoveByAction(Spikeduration, new Vector2(0, 200), spikedowns[0]),
                new MoveByAction(Spikeduration, new Vector2(0, -200), spikedowns[0])
            ));
            spikedowns[1].AddAction(Actions.Forever(
                new MoveByAction(Spikeduration, new Vector2(0, 200), spikedowns[1]),
                new MoveByAction(Spikeduration, new Vector2(0, -200), spikedowns[1])
            ));
            spikedowns[2].AddAction(Actions.Forever(
                new MoveByAction(Spikeduration, new Vector2(0, 200), spikedowns[2]),
                new MoveByAction(Spikeduration, new Vector2(0, -200), spikedowns[2])
            ));
            ...
            balls.Add(new Ball(new RectF(620, 340, 50, 50)));
            balls.Add(new Ball(new RectF(50, 190, 50, 50)));

            float Ballduration = 0.8f;
            ...
            balls[1].AddAction(Actions.Forever(
                new MoveByAction(Ballduration, new Vector2(800, 0), balls[1]),
                new MoveByAction(Ballduration, new Vector2(-800, 0), balls[1])
            ));
